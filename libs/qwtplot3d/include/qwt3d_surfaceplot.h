...
public:
  ...
  bool loadFromData(Qwt3D::TripleField const& data, Qwt3D::CellField const& poly, LineGroups const& groups = LineGroups() );
...
public slots:
  void setGroupVisible(const QString& groupName, bool shown);
