...
class CHockeyManager::PrivateData
{
public:
  PrivateData(){}
  ~PrivateData(){}
  ...
  QMap<QString, Championat> championatsModif;
  QMap<QString, NextTur> nextTurs;
  Ui::statistica ui;
  CStorage storage;
};

CHockeyManager::CHockeyManager(QWidget *parent)
  : QMainWindow(parent)
{
...
CHockeyManager::~CHockeyManager()
{
  delete m_pData;
}

void CHockeyManager::Do()
{
...
void CHockeyManager::AddValues(const QString& tableName)
{
...
void CHockeyManager::AnalizeCommonPosition()
{
...
void CHockeyManager::FormDataTeams()
{
  foreach(QString champName, m_pData->championats.keys())
    for(int i = 0; i < m_pData->championats[champName].count(); ++i)
...
QVector<QString> CHockeyManager::GetSortNextNames(QString champName)
{
...
void CHockeyManager::ShowSource()
{
//  foreach(QString champName, m_pData->championats.keys())
//  {
...
void CHockeyManager::onChecked(const QModelIndex &index)
{
